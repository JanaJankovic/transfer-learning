...
if __name__ == "__main__":
    ...
    # small_datasets = ["Afghanistan", "Lebanon", "Palestine"]
    small_datasets = ["Lao", "Palestine"]
    ...
    print("Transfer learning Palestine")
    tl.transfer_learning_pipeline(
        "Palestine", large_datasets, commodity, c.get_tl_model_results()
    )
