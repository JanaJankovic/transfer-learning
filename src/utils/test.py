...
def prepare_model(pretrained_model, params):
    ...
    if params['network_type'] == 'RNN':
        x = m.add_simple_RNN_layers(reshaped_output, params['num_layers'], params['neurons_per_layer'])
    elif params['network_type'] == 'LSTM':
        x = m.add_LSTM_layers(reshaped_output, params['num_layers'], params['neurons_per_layer'])
    elif params['network_type'] == 'GRU':
        x = m.add_GRU_layers(reshaped_output, params['num_layers'], params['neurons_per_layer'])
